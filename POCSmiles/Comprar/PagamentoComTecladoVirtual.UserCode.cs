    ...
    public partial class PagamentoComTecladoVirtual
    {
		...
		private void SelectItemListBoxAsHuman(string selectTagElement, string itemName, string elementIndex){
        	try 
        	{
        		...
        		Utils.SelectItemListBoxAsHuman(repo.SmilesOMelhorProgramaDeMilhasS1.AbsoluteBasePath.ToResolvedString() + selectTagElement, "(?i)" + itemName + "(?-i)", elementIndex);
        ...
        {
        	if (Utils.CheckExist(repo.SmilesOMelhorProgramaDeMilhasS1.EmissaoSemMilhas_TagEuConcordoComOsInfo.AbsolutePath.ToResolvedString(),3000)) {
        		repo.SmilesOMelhorProgramaDeMilhasS1.EmissaoSemMilhas_TagEuConcordoComOs.Click(Duration.FromMilliseconds(1));
        	}
        }

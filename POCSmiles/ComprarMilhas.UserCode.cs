...
namespace POCSmiles
{
    public partial class ComprarMilhas
    {
        ...
        private void SelectItemListBox(string selectTagElement, string itemName){
        	...
        	{
        		Report.Error("ComprarMilhas - Error launched trying to select item '" + itemName + "' on element '" + selectTagElement + "'");
        		throw new System.Exception("ComprarMilhas.SeletItemListBox");
        	}
        }
    }
}
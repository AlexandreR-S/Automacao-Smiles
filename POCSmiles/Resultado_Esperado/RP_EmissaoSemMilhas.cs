...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The RP_EmissaoSemMilhas recording.
    /// </summary>
    [TestModule("86202f25-3d4e-4bf7-9f25-ef5ee82dfe2d", ModuleType.Recording, 1)]
    public partial class RP_EmissaoSemMilhas : ITestModule
    {
        /// <summary>
        ...
        static RP_EmissaoSemMilhas instance = new RP_EmissaoSemMilhas();

        /// <summary>
        /// Constructs a new instance.
        /// </summary>
        public RP_EmissaoSemMilhas()
        {
            CPFSmilesID = "";
            DataPartida1 = "";
            QuantidadeAdultos = "";
        ...
        /// </summary>
        public static RP_EmissaoSemMilhas Instance
        {
            get { return instance; }
        }
...
#region Variables
        ...
        /// </summary>
        [TestVariable("187e8539-19fc-4b7e-bfc5-997903ed3cf1")]
        ...
        /// </summary>
        [TestVariable("bdc00507-ccc9-4292-95b8-29687cae303b")]
        ...
        /// </summary>
        [TestVariable("e549afce-b127-4630-901a-637b5d3b43f4")]
        ...
        /// </summary>
        [TestVariable("861e753a-d73d-4aa5-928f-2e5fb65a1931")]
        ...
        /// </summary>
        [TestVariable("39c3115a-2e82-4d89-ae76-aa3d82e037cb")]
        ...
        /// </summary>
        [TestVariable("b7beb4e8-57a9-4e1e-9806-a266137de06f")]
        ...
        void ITestModule.Run()
        {
            ...
            Report.Log(ReportLevel.Info, "Validation", "Validating Exists on item 'SmilesOMelhorProgramaDeMilhasS1.BilheteEmitidoComSucesso'.", repo.SmilesOMelhorProgramaDeMilhasS1.BilheteEmitidoComSucessoInfo, new RecordItemIndex(0));
            Validate.Exists(repo.SmilesOMelhorProgramaDeMilhasS1.BilheteEmitidoComSucessoInfo);
            Delay.Milliseconds(100);
            
            FocusModalMenssage();
            Delay.Milliseconds(0);
            
            SavePNRDB(CPFSmilesID, DataPartida1, QuantidadeAdultos, QuantidadeCriancas, QuantidadeBebes, ObservacoesPNR);
            Delay.Milliseconds(0);
            
            Report.Screenshot(ReportLevel.Success, "User", "", null, false, new RecordItemIndex(3));
            
            Report.Log(ReportLevel.Info, "Keyboard", "Key sequence '{NEXT}'.", new RecordItemIndex(4));
            Keyboard.Press("{NEXT}");
            Delay.Milliseconds(0);

...
{
    public partial class CancelarAssinatura
    {
        /// <summary>
        ...
        public void SelectRadioButton(string option)
        {
        	try {
        		...
        		Utils.SelectOptionComboBox(option, repo);
        		Report.Info("Option '" + option + "' selected");
        	} catch (Exception e) {
        		Report.Failure("Error launched trying to select option '" + option + "'. Erro: " + e.Message);
        	}
        }

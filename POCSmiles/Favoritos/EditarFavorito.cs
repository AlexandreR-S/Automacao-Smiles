...
#pragma warning disable 0436 //(CS0436) The type 'type' in 'assembly' conflicts with the imported type 'type2' in 'assembly'. Using the type defined in 'assembly'.
    /// <summary>
    ///The EditarFavorito recording.
    /// </summary>
    [TestModule("78f9bb2a-0321-4b51-84b6-ca9c2c53af68", ModuleType.Recording, 1)]
    public partial class EditarFavorito : ITestModule
    {
        /// <summary>
...
#region Variables
        ...
        void ITestModule.Run()
        {
            ...
            Key_Sequence(Nome, "//input[#'_favoritepassengerportlet_WAR_smilesmemberportlet_FirstName']");
            Delay.Milliseconds(0);
            
            Key_Sequence(Sobrenome, "//input[#'_favoritepassengerportlet_WAR_smilesmemberportlet_LastName']");
            Delay.Milliseconds(0);
            
            SeleclGenrerFlag(Sexo);
            Delay.Milliseconds(0);
            
            Key_Sequence(DiaNascimento, "//input[@name='day']");
            Delay.Milliseconds(0);
            
            Key_Sequence(MesNascimento, "//input[@name='month']");
            Delay.Milliseconds(0);
            
            Key_Sequence(AnoNascimento, "//input[@name='year']");
            Delay.Milliseconds(0);
            
            Invoke_Action_Favorito_TipoDocumento(TipoDocumento);
            Delay.Milliseconds(0);
            
            Key_Sequence(NumeroDocumento, "//input[@name='documentNumber']");
            Delay.Milliseconds(0);
            
            Key_Sequence(Email, "//input[@name='email']");
            Delay.Milliseconds(0);

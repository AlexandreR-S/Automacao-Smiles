...
{
    public partial class NBV_BuscarVoos
    {
        /// <summary>
        ...
        private void selectTrecho(string tipoTrajeto){
        	try {
        ...
        public void insertPassengers(string adultos, string criancas, string bebes){
        	try {
        ...
        public void ClickIfExist()
        {
        	if (Utils.CheckExist(repo.SmilesOMelhorProgramaDeMilhasS1.BuscaVoo_MensagemMesmoDiaInfo.AbsolutePath.ToResolvedString(),3000)) {
        		repo.SmilesOMelhorProgramaDeMilhasS1.OK.Click(Duration.FromMilliseconds(1));
        	}
        }
    }
}